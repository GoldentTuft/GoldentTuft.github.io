...
},{"./bundle-url":"C:/Users/a/AppData/Roaming/npm/node_modules/parcel/src/builtins/bundle-url.js"}],"style.scss":[function(require,module,exports) {
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{
			dropDown1Config: {id: 'dropDown1', state: $author$project$Main$Closed},
			dropDown2Open: false,
			hoverMenuOpen: false,
			menu2Open: false,
			menuOpen: false,
			page: $author$project$Main$Top,
			rightSideBar: _List_fromArray(
				['item1', 'longlonglonglong']),
			searchBarOpen: false,
			searchText: ''
		},
		$elm$core$Platform$Cmd$none);
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'NoOp':
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			case 'SelDropDownItem':
				var item = msg.a;
				return A2(
					$author$project$Main$update,
					$author$project$Main$SetState($author$project$Main$Closed),
					_Utils_update(
						model,
						{
							dropDown2Open: false,
							hoverMenuOpen: false,
							menuOpen: false,
							rightSideBar: A2($elm$core$List$cons, item, model.rightSideBar)
						}));
			case 'SetState':
				var state = msg.a;
				var config = model.dropDown1Config;
			...
			case 'ToggleMenu2':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{menu2Open: !model.menu2Open}),
					$elm$core$Platform$Cmd$none);
			case 'ToggleSearchBar':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{searchBarOpen: !model.searchBarOpen}),
					$elm$core$Platform$Cmd$none);
			case 'ToAbout':
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Main$rootFontSize = 20;
var $author$project$Main$rem = function (x) {
	return $elm$core$Basics$round($author$project$Main$rootFontSize * x);
};
		...
		[
				...
				[
					...
					_List_fromArray(
						[
							...
							$author$project$Main$rem(3))
						]),
					$mdgriffith$elm_ui$Element$text('A')),
					$mdgriffith$elm_ui$Element$text('elm-uiを使用してレイアウトしてみました。menuとdrop2は愚直に簡単に実装されています。drop1はあまり意味がなさそうですがフォーカスを制御した少し凝ったものです。')
				])),
			A2(
			$mdgriffith$elm_ui$Element$paragraph,
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$text('elm-uiを使用すると、cssを利用せずにレイアウト面はできてしまいます。cssの苦痛から少し解放されます。')
				]))
		]));
...
var $author$project$Main$style = F2(
	function (a, b) {
		return $mdgriffith$elm_ui$Element$htmlAttribute(
			A2($elm$html$Html$Attributes$style, a, b));
	});
var $author$project$Main$footer = A2(
	...
	_List_fromArray(
		[
			...
			$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
			$mdgriffith$elm_ui$Element$padding(10),
			A2($author$project$Main$style, 'border-top', '1px solid rgb(0, 0, 0, 0.4)'),
...
var $author$project$Main$InputSearchText = function (a) {
	return {$: 'InputSearchText', a: a};
};
var $author$project$Main$Open = {$: 'Open'};
var $author$project$Main$OpenDropDown2 = {$: 'OpenDropDown2'};
var $author$project$Main$OpenHover = {$: 'OpenHover'};
var $author$project$Main$OpenMenu = {$: 'OpenMenu'};
var $author$project$Main$ToAbout = {$: 'ToAbout'};
var $author$project$Main$ToTop = {$: 'ToTop'};
var $author$project$Main$ToggleMenu2 = {$: 'ToggleMenu2'};
var $author$project$Main$ToggleSearchBar = {$: 'ToggleSearchBar'};
...
var $author$project$Main$SelDropDownItem = function (a) {
	return {$: 'SelDropDownItem', a: a};
};
...
var $author$project$Main$tabindex = function (i) {
	return $mdgriffith$elm_ui$Element$htmlAttribute(
		$elm$html$Html$Attributes$tabindex(i));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Main$tabindex(0),
						$author$project$Main$class('dropDown_item'),
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
						A2($mdgriffith$elm_ui$Element$paddingXY, 10, 10),
						$mdgriffith$elm_ui$Element$Events$onClick(
						$author$project$Main$SelDropDownItem('item1')),
						$mdgriffith$elm_ui$Element$Events$onFocus(
						$author$project$Main$SetState($author$project$Main$Open)),
				...
				_List_fromArray(
					[
						...
						A2($mdgriffith$elm_ui$Element$paddingXY, 10, 10),
						$mdgriffith$elm_ui$Element$Events$onClick(
						$author$project$Main$SelDropDownItem('itemitemitemitem2')),
						$mdgriffith$elm_ui$Element$Events$onFocus(
						$author$project$Main$SetState($author$project$Main$Open)),
						$mdgriffith$elm_ui$Element$Events$onLoseFocus(
						$author$project$Main$SetState($author$project$Main$Closed))
					]),
				$mdgriffith$elm_ui$Element$text('itemitemitemitem2')),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
						...
						A2($mdgriffith$elm_ui$Element$paddingXY, 10, 10),
						$mdgriffith$elm_ui$Element$Events$onClick(
						$author$project$Main$SelDropDownItem('item3')),
						$mdgriffith$elm_ui$Element$Events$onFocus(
						$author$project$Main$SetState($author$project$Main$Open)),
						$mdgriffith$elm_ui$Element$Events$onLoseFocus(
						$author$project$Main$SetState($author$project$Main$Closed))
					]),
				$mdgriffith$elm_ui$Element$text('item3')),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
...
var $author$project$Main$CloseDropDown2 = {$: 'CloseDropDown2'};
...
var $author$project$Main$modalStyle = function (alpha) {
	return _List_fromArray(
		[
			$mdgriffith$elm_ui$Element$Background$color(
			A4($mdgriffith$elm_ui$Element$rgba, 0.0, 0.0, 0.0, alpha)),
			...
			$mdgriffith$elm_ui$Element$htmlAttribute(
			A2($elm$html$Html$Attributes$style, 'height', '100%')),
			A2($author$project$Main$style, 'cursor', 'default')
		]);
};
var $author$project$Main$simpleDropDownItem = function (label) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$Events$onClick(
				$author$project$Main$SelDropDownItem(label))
			]),
		$mdgriffith$elm_ui$Element$text(label));
};
var $author$project$Main$dropDown2 = A2(
	$mdgriffith$elm_ui$Element$column,
	_List_Nil,
	_List_fromArray(
		[
			...
			$mdgriffith$elm_ui$Element$el,
			_Utils_ap(
				$author$project$Main$modalStyle(0),
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Events$onClick($author$project$Main$CloseDropDown2)
					])),
			$mdgriffith$elm_ui$Element$none),
			A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
					$author$project$Main$class('dropDown'),
					A2($author$project$Main$style, 'z-index', '2000'),
					A2($mdgriffith$elm_ui$Element$paddingXY, 0, 10)
				]),
			_List_fromArray(
				[
					$author$project$Main$simpleDropDownItem('item1'),
					$author$project$Main$simpleDropDownItem('itemitemitem2'),
					$author$project$Main$simpleDropDownItem('item3')
				]))
		]));
var $mdgriffith$elm_ui$Element$fillPortion = $mdgriffith$elm_ui$Internal$Model$Fill;
var $author$project$Main$hoverMenu = A2(
	$mdgriffith$elm_ui$Element$column,
	_List_fromArray(
		[
			$author$project$Main$class('dropDown'),
...
var $author$project$Main$id = A2($elm$core$Basics$composeL, $mdgriffith$elm_ui$Element$htmlAttribute, $elm$html$Html$Attributes$id);
var $mdgriffith$elm_ui$Element$Input$HiddenLabel = function (a) {
	return {$: 'HiddenLabel', a: a};
};
var $mdgriffith$elm_ui$Element$Input$labelHidden = $mdgriffith$elm_ui$Element$Input$HiddenLabel;
var $author$project$Main$CloseMenu = {$: 'CloseMenu'};
var $author$project$Main$menuItem = function (label) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				$author$project$Main$class('menu_item'),
				A2($mdgriffith$elm_ui$Element$paddingXY, 10, 10),
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$Events$onClick(
				$author$project$Main$SelDropDownItem(label))
...
var $author$project$Main$menu = A2(
	$mdgriffith$elm_ui$Element$row,
	$author$project$Main$modalStyle(0.6),
	_List_fromArray(
		[
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
					$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
					$mdgriffith$elm_ui$Element$Events$onClick($author$project$Main$CloseMenu)
				]),
			$mdgriffith$elm_ui$Element$none),
			A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
					$author$project$Main$class('menu'),
					A2($author$project$Main$style, 'z-index', '2000'),
					A2($mdgriffith$elm_ui$Element$paddingXY, 0, 10),
					$mdgriffith$elm_ui$Element$alignRight,
					$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill)
			...
			_List_fromArray(
				[
					$author$project$Main$menuItem('item1'),
					$author$project$Main$menuItem('itemitemitemitem2'),
					$author$project$Main$menuItem('item3'),
					$author$project$Main$menuItem('item4'),
					$author$project$Main$menuItem('item5')
				]))
		]));
...
var $author$project$Main$nav = function (model) {
	var navHeight = model.menu2Open ? $mdgriffith$elm_ui$Element$px(210) : $mdgriffith$elm_ui$Element$px(70);
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
						$mdgriffith$elm_ui$Element$height(navHeight)
					]),
				$mdgriffith$elm_ui$Element$none),
				A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
						$mdgriffith$elm_ui$Element$height(navHeight),
						A2($author$project$Main$style, 'position', 'fixed'),
						A2($author$project$Main$style, 'z-index', '100'),
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$Main$class('nav_brand'),
										$mdgriffith$elm_ui$Element$Font$size(
										$author$project$Main$rem(2)),
										$mdgriffith$elm_ui$Element$alignLeft
									]),
								$mdgriffith$elm_ui$Element$text('Brand')),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_Utils_ap(
									_List_fromArray(
										[
											A2($author$project$Main$style, 'user-select', 'none'),
											$author$project$Main$class('nav_item'),
											$mdgriffith$elm_ui$Element$pointer
										]),
									model.dropDown2Open ? _List_fromArray(
										[
											$mdgriffith$elm_ui$Element$below($author$project$Main$dropDown2)
										]) : _List_fromArray(
										[
											$mdgriffith$elm_ui$Element$Events$onClick($author$project$Main$OpenDropDown2)
										])),
								$mdgriffith$elm_ui$Element$text('drop2▼')),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
									[
										$author$project$Main$class('nav_item'),
										$mdgriffith$elm_ui$Element$Events$onClick($author$project$Main$ToggleSearchBar)
									]),
								$mdgriffith$elm_ui$Element$text('🔍')),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
									[
										$author$project$Main$class('nav_item'),
										$mdgriffith$elm_ui$Element$Events$onClick($author$project$Main$ToggleMenu2)
									]),
								$mdgriffith$elm_ui$Element$text('menu2')),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_Utils_ap(
									_List_fromArray(
										[
											$author$project$Main$class('nav_item'),
											$mdgriffith$elm_ui$Element$Events$onMouseEnter($author$project$Main$OpenHover),
											$mdgriffith$elm_ui$Element$Events$onMouseLeave($author$project$Main$CloseHover)
										]),
									model.hoverMenuOpen ? _List_fromArray(
										[
											$mdgriffith$elm_ui$Element$below($author$project$Main$hoverMenu)
										]) : _List_Nil),
								$mdgriffith$elm_ui$Element$text('hover')),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
									[$mdgriffith$elm_ui$Element$alignRight]),
								...
								_List_fromArray(
									[
										$author$project$Main$class('nav_item'),
										$mdgriffith$elm_ui$Element$Events$onClick($author$project$Main$ToTop)
									]),
								...
								_List_fromArray(
									[
										$author$project$Main$class('nav_item'),
										$mdgriffith$elm_ui$Element$Events$onClick($author$project$Main$ToAbout)
									]),
								...
								_Utils_ap(
									...
									model.menuOpen ? _List_fromArray(
										[
											$mdgriffith$elm_ui$Element$below($author$project$Main$menu)
										]) : _List_fromArray(
										[
											$mdgriffith$elm_ui$Element$Events$onClick($author$project$Main$OpenMenu)
										])),
								...
								_Utils_ap(
									_List_fromArray(
										[
											$author$project$Main$class('nav_item'),
											$author$project$Main$id(model.dropDown1Config.id),
											$author$project$Main$tabindex(-1)
										]),
									function () {
										var _v0 = model.dropDown1Config.state;
										if (_v0.$ === 'Closed') {
											return _List_fromArray(
												[
													$mdgriffith$elm_ui$Element$Events$onClick(
								...
								$mdgriffith$elm_ui$Element$text('drop1▼'))
							])),
						model.menu2Open ? A2(
						$mdgriffith$elm_ui$Element$column,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$author$project$Main$menuItem('hoge'),
								$author$project$Main$menuItem('piyo')
							])) : $mdgriffith$elm_ui$Element$none,
						model.searchBarOpen ? A2(
						$mdgriffith$elm_ui$Element$row,
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$width(
										$mdgriffith$elm_ui$Element$fillPortion(70)),
										$mdgriffith$elm_ui$Element$Border$rounded(10)
									]),
								{
									label: $mdgriffith$elm_ui$Element$Input$labelHidden('hoge'),
									onChange: $author$project$Main$InputSearchText,
...
var $author$project$Main$mainLayout = F2(
	function (page, model) {
		return A2(
			$mdgriffith$elm_ui$Element$layout,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Font$size($author$project$Main$rootFontSize)
				]),
			A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
...
var $author$project$Main$box = A2(
	$mdgriffith$elm_ui$Element$el,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$Background$color(
...
var $author$project$Main$miniBox = A2(
	$mdgriffith$elm_ui$Element$el,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$Background$color(
...
var $author$project$Main$top = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
					...
					[
						...
						_Debug_todo(
							'Main',
							{
								...
								end: {line: 527, column: 35}
							})),
						$mdgriffith$elm_ui$Element$width(
						$mdgriffith$elm_ui$Element$fillPortion(80)),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[$mdgriffith$elm_ui$Element$alignRight]),
								$mdgriffith$elm_ui$Element$text('item1')),
								$mdgriffith$elm_ui$Element$text('itemitem2')
							])),
						A2(
						$mdgriffith$elm_ui$Element$column,
						_List_fromArray(
						...
						_Utils_ap(
							_List_fromArray(
								[
									...
									_List_fromArray(
										[$mdgriffith$elm_ui$Element$centerX]),
									$mdgriffith$elm_ui$Element$text('hoge1')),
									A2(
									$mdgriffith$elm_ui$Element$row,
									_List_fromArray(
										[
											...
											_Debug_todo(
												'Main',
												{
													start: {line: 537, column: 57},
													end: {line: 537, column: 67}
												}))
										]),
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$mdgriffith$elm_ui$Element$Background$color(
													A3($mdgriffith$elm_ui$Element$rgb255, 100, 200, 100)),
													$mdgriffith$elm_ui$Element$width(
													$mdgriffith$elm_ui$Element$fillPortion(70)),
													$mdgriffith$elm_ui$Element$height(
													$mdgriffith$elm_ui$Element$px(300)),
											...
											$mdgriffith$elm_ui$Element$text('hoge2')),
											A2(
											$mdgriffith$elm_ui$Element$el,
											_List_fromArray(
												[
									...
									_List_fromArray(
										[
											...
											_Debug_todo(
												'Main',
												{
													start: {line: 542, column: 57},
													end: {line: 542, column: 67}
												}))
										]),
									_List_fromArray(
										[
											...
											A2(
												...
												_List_fromArray(
													[$mdgriffith$elm_ui$Element$centerX]),
												$mdgriffith$elm_ui$Element$text('hoge3'))),
											A2(
											$mdgriffith$elm_ui$Element$el,
											_List_fromArray(
												[
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[$mdgriffith$elm_ui$Element$alignLeft]),
													$mdgriffith$elm_ui$Element$text('best: ')),
													A2(
													$mdgriffith$elm_ui$Element$el,
													_List_fromArray(
														[
													...
													$mdgriffith$elm_ui$Element$text('1800.80'))
												])),
											A2(
											$mdgriffith$elm_ui$Element$row,
											_List_fromArray(
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[$mdgriffith$elm_ui$Element$alignLeft]),
													$mdgriffith$elm_ui$Element$text('keys per minute: ')),
													A2(
													$mdgriffith$elm_ui$Element$el,
													_List_fromArray(
														[
									...
									A2($elm$core$List$repeat, 50, $author$project$Main$miniBox))
								]),
							A2($elm$core$List$repeat, 5, $author$project$Main$box))),
						A2(
						$mdgriffith$elm_ui$Element$column,
						_List_fromArray(
							[
	...
	return {
		body: _List_fromArray(
			[
				...
				if (_v0.$ === 'Top') {
					return A2(
						$author$project$Main$mainLayout,
						$author$project$Main$top(model),
						model);
				} else {
					return A2($author$project$Main$mainLayout, $author$project$Main$about, model);
				}
			}()
			]),
		title: 'layout study1'
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"SelDropDownItem":["String.String"],"SetState":["Main.DropDownState"],"OpenDropDown2":[],"CloseDropDown2":[],"OpenMenu":[],"CloseMenu":[],"ToAbout":[],"ToTop":[],"ToggleMenu2":[],"ToggleSearchBar":[],"InputSearchText":["String.String"],"OpenHover":[],"CloseHover":[]}},"Main.DropDownState":{"args":[],"tags":{"Open":[],"Closed":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});
...
},{"./style.scss":"style.scss","./Main.elm":"Main.elm"}],"C:/Users/a/AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/a/AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js","main.js"], null)
