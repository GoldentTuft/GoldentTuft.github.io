...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"style/app.scss":[function(require,module,exports) {
...
var $author$project$Main$myClass = function (name) {
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$myClass('main')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$author$project$Main$myClass('nav')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$author$project$Main$myClass('container')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$author$project$Main$myClass('nav_brand')
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$author$project$Main$myClass('nav_items')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												$author$project$Main$myClass('nav_item')
											]),
										_List_fromArray(
											[
												$elm$html$Html$text('item1')
											])),
										A2(
										$elm$html$Html$span,
										_List_fromArray(
				...
				_List_fromArray(
					[
						$author$project$Main$myClass('content')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$Main$myClass('button'),
										$author$project$Main$myClass('button_success')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('hoge')
								...
								_List_fromArray(
									[
										$author$project$Main$myClass('button'),
										$author$project$Main$myClass('button_warning')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('hoge')
...
require('../style/app.scss'); //require('../style/reset.scss');
...
},{"../style/app.scss":"style/app.scss","../Main.elm":"Main.elm"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
